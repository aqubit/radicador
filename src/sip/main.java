 ...
 * main.java
 *
 * Created on 19 de septiembre de 2006, 10:29
...
public class main extends AbstractPageBean {
    ...
    private HtmlPanelGrid pnlDescripcion = new HtmlPanelGrid();

    public HtmlPanelGrid getPnlDescripcion() {
        return pnlDescripcion;
    }

    public void setPnlDescripcion(HtmlPanelGrid hpg) {
        this.pnlDescripcion = hpg;
    }
